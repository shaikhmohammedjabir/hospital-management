...
class Appointment(Tk):
    ...
    def __addPatient(self,frame):
        ...
        # submit_btn.bind('<Return>', lambda event: self._Appointment__addPatient(right_frame))
        # submit_btn.bind('<KP_Enter>', lambda event: self._Appointment__addPatient(right_frame))
        # submit_btn.bind('<space>', lambda event: self._Appointment__addPatient(right_frame))
        # submit_btn.bind('<Button-1>', lambda event: self._Appointment__addPatient(right_frame))
        # submit_btn.bind('<Button-3>', lambda event: self._Appointment__addPatient(right_frame))
